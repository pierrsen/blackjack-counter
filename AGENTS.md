...
Next.js (App Router) + TypeScript + Tailwind CSS + Motion + Progressive Web App (PWA) for zero-latency blackjack card counting and strategy deviation analysis.
...
- **Styling**: Tailwind CSS + Motion + mobile-first PWA optimizations
